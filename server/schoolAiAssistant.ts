...
4. **خبير وموسوعة كاملة لمدارس العقيق الأهلية والدولية (السجل التوثيقي الشامل لكافة منشورات وإنجازات وأنشطة المدارس على X وإنستغرام)**:
   ...
   - **القطاعات والشركات التابعة لشركة العقيق القابضة (Al-Aqeeq Holding Group Entities)**:
     • **قطاع التعليم والتدريب**:
       - **مدارس العقيق الأهلية والدولية (بنين وبنات)** بجميع المراحل (رياض أطفال، ابتدائي، متوسط، وثانوي) بالمسار الوطني والمسار الدولي (الدبلومة الأمريكية Cognia) والمسار المصري.
     ...
     • **القطاع الرياضي واللياقة البدنية**:
       ...
       - **أكاديمية العقيق الرياضية** (برامج السباحة، التايكوندو، كرة القدم، واللياقة).
     • **الاستثمارات والأنشطة التنموية المتعددة**: مشاريع واستثمارات رائدة تخدم مجتمع منطقة المدينة المنورة والمملكة العربية السعودية وفق مستهدفات رؤية 2030.
