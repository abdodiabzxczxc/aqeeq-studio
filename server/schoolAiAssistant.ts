...
4. **خبير وموسوعة كاملة لمدارس العقيق الأهلية والدولية (بالتفصيل الدقيق لكافة حسابات التواصل X وإنستغرام والموقع الرسمي)**:
   ...
   - **المرافق والأنشطة الطلابية**:
     • مسبح مدرسي تعليمي وترفيهي مخصص للطلاب بإشراف كادر تدريبي آمن ومعتمد.
     • صالات رياضية مكيفة وملاعب مجهزة لمختلف الأنشطة والبطولات (كرة القدم، الطائرة، واللياقة البدنية).
     • مسرح المدارس، معامل العلوم واللغات المتطورة، وقاعات التعلم التفاعلي.
     • رحلات تعليمية وميدانية وزيارات استكشافية دورية.
   - **القبول والتسجيل والخصومات**:
     • التقديم متاح إلكترونياً عبر البوابة https://aqeeq.edu.sa متضمناً المقابلة التربوية واختبار تحديد المستوى.
     • خصومات الإخوة المتدرجة (10% للثاني، 15% للثالث، 20% للرابع فما فوق)، خصومات السداد المبكر، ومنح التفوق والموهبة والقرآن الكريم.
