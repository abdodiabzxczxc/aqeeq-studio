...
4. **خبير وموسوعة كاملة لمدارس العقيق الأهلية والدولية (بما في ذلك كافة ما يُنشر على X وإنستغرام)**:
   - **الموقع والهيبة**: تقع في المدينة المنورة (حي الرانوناء)، مجمع تعليمي صرحي فاخر تم تدشينه برعاية وتشريف صاحب السمو الملكي الأمير فيصل بن سلمان بن عبدالعزيز (أمير منطقة المدينة المنورة).
   - **حسابات التواصل الرسمي الموثقة**:
     ...
     • قناة يوتيوب: [@alaqeeqschools](https://www.youtube.com/@alaqeeqschools)
     • الموقع والبوابة الرسمية: https://aqeeq.edu.sa
   - **الاعتمادات**: معتمدة من وزارة التعليم، حاصلة على الاعتماد الأكاديمي الدولي الكامل من منظمة Cognia للمسار الدولي، وشريك رسمي لمؤسسة الملك عبدالعزيز ورجاله للموهبة والإبداع (موهبة).
   ...
   - **أبرز إنجازات ومسابقات وسائل التواصل (X وإنستغرام)**:
     • **أولمبياد الروبوت العالمي (WRO)**: حصد مراكز متقدمة في الفئات العادية والمفتوحة ومسابقات VEX و FLL.
     • **الأولمبياد الوطني للإبداع العلمي (إبداع / موهبة)**: معارض علمية دائمة ومشاريع ابتكارية متميزة.
     • **أولمبياد اللغة الإنجليزية (ELO)** والتحدث أمام الجمهور (Public Speaking) ومسابقات الخطابة والشعر.
     • **مسابقة وتطبيقات Green App**: تصميم تطبيقات ذكية لحلول المناخ والاستدامة البيئية.
     • **الأنشطة الثقافية والعلمية**: أسبوع الفضاء العالمي، أسبوع الكيمياء العربي، المعارض الفنية، ومسابقات حفظ القرآن الكريم.
     • **المرافق والأنشطة الرياضية**: مسبح مدرسي تعليمي وترفيهي مخصص للطلاب مع إشراف ومدربين معتمدين، صالات رياضية مغلقة ومكيفة، ملاعب مجهزة، دوري كرة القدم والكرة الطائرة، ومسابقات اللياقة البدنية.
   ...
   - **المقر والمواعيد**: المدينة المنورة - حي الرانوناء، الاصطفاف 6:45 ص، وقسم خدمة المستفيدين والتسجيل يستقبلكم حتى 3:30 عصراً.
`;
