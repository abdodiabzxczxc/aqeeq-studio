...
# Remove the Subtabs Bar and replace Subtab 1 opening
...
# Close Hero and open App
hero_close_pattern = re.compile(r'\s*\}\)\(\)\}\n\s*<\/div>\n\s*<\/div>\n\s*\)\}\n\n\s*\{\/\* Subtab 2: SMART APP SHOWCASE \*\/\}\n\s*\{orchestrationSubTab === "app" && \(')
content = re.sub(
    hero_close_pattern,
    r'''
                })()}
...
# Close App and open Campuses
app_close_pattern = re.compile(r'\s*<\/div>\n\s*<\/div>\n\s*<\/div>\n\s*\)\}\n\n\s*\{\/\* Subtab 3: CAMPUSES & CONTACTS \*\/\}\n\s*\{orchestrationSubTab === "campuses" && \(')
content = re.sub(
    app_close_pattern,
    r'''
                  </div>
...
# Close Campuses and open Sections
campuses_close_pattern = re.compile(r'\s*<\/div>\n\s*<\/div>\n\s*<\/div>\n\s*\)\}\n\n\s*\{\/\* Subtab 4: SECTIONS, BENTO, SOCIAL, FOOTER \*\/\}\n\s*\{orchestrationSubTab === "sections" && \(')
content = re.sub(
    campuses_close_pattern,
    r'''
                  </div>
                </div>
              </div>
...
# Close Sections
sections_close_pattern = re.compile(r'\s*<\/div>\n\s*<\/div>\n\s*<\/div>\n\s*\)\}\n\n\s*\{\/\* Bottom Save Bar \*\/\}')
content = re.sub(
    sections_close_pattern,
    r'''
                </div>
              </div>
            </div>
