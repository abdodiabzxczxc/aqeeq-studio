              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/60 to-transparent px-5 pb-5 pt-20 text-right">
                <div className="flex items-center gap-2 mb-1.5">
                  ...
                  <span className="text-[10px] font-bold text-[#f8ca14]/90">
                    {posts.length} منشور وفعالية
                  </span>
                </div>
                <VisualEditable id="showcase-cover-title" tag="text" label="عنوان غلاف الأخبار" defaultText={showcase.title} as="p" className="mt-1 text-base sm:text-lg font-black text-white leading-snug line-clamp-2 drop-shadow-md" />
              </div>
            </div>
          </div>
        </div>
...
export default function AqeeqShowcasePage() {
  ...
  return (
    ...
    >
      <section id="aqeeq-showcase-feed" className="mx-auto max-w-[1380px] 2xl:max-w-[1560px] px-4 sm:px-6 md:px-8 pt-8 sm:pt-10 pb-28 sm:pb-32">
