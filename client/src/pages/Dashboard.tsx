  ...
  return <main dir="rtl" className="aq-admin-surface min-h-screen w-full overflow-x-hidden text-slate-100">
    ...
    <div className="container py-8 md:py-10">
      {activeTab === "overview" && <div className="space-y-7">
        ...
        <Reveal delay={0.08}><div className="grid grid-cols-2 gap-3 lg:grid-cols-4"><MetricCard label="الفعاليات" value={ceremonies?.length ?? 0} icon={Sparkles} color="text-amber-400" /><MetricCard label="إجمالي الضيوف" value={totals.guests} icon={Users} color="text-[#f8ca14]" /><MetricCard label="الحضور المسجل" value={totals.attended} icon={CheckCircle2} color="text-emerald-400" /><MetricCard label="تذاكر مدفوعة" value={totals.paid} icon={FileText} color="text-amber-200" /></div></Reveal>
