...
export function ArticlesParallaxScroll({
  ...
  return (
    <div
      ref={containerRef}
      className={`relative flex flex-col self-auto overflow-hidden antialiased transition-colors duration-500 pb-12 sm:pb-16 [perspective:1200px] [transform-style:preserve-3d] ${
    ...
    >
      ...
      >
        <div
          className={`absolute -top-32 right-1/3 h-[580px] w-[580px] rounded-full blur-[140px] opacity-25 ${
