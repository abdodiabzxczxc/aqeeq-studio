    ...
    >
      <div className="mx-auto max-w-[1240px] px-5 md:px-8">
        ...
        <div className="mb-12 md:mb-16 text-right max-w-2xl">
          ...
          />
          <VisualEditable
            id="studio-weekly-desc"
            tag="text"
            label="وصف أحداث الأسبوع"
            defaultText="محطات النجاح، التكريمات، والفعاليات الأبرز التي شهدتها مدارس العقيق هذا الأسبوع، مصفوفة بتجربة بطاقات تراكمية تفاعلية."
            as="p"
            className={`mt-2 text-xs sm:text-sm leading-relaxed ${dark ? "text-slate-400" : "text-slate-600"}`}
          />
        </div>
