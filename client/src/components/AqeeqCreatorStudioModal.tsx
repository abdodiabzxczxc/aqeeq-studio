  ...
  const creationOptions = [
    {
      ...
      icon: <Newspaper size={32} className="text-blue-500" />,
      path: "/articles/manage",
      glow: "hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] border-blue-500/20",
    },
    {
      id: "podcast",
      title: "حلقة بودكاست",
      ...
      path: "/podcast/manage",
      glow: "hover:shadow-[0_0_30px_rgba(168,85,247,0.3)] border-purple-500/20",
    },
    {
      id: "journal",
      title: "إصدار مجلة",
      ...
      path: "/journal/manage",
      glow: "hover:shadow-[0_0_30px_rgba(245,158,11,0.3)] border-amber-500/20",
    },
    {
      id: "album",
      title: "ألبوم صور",
      desc: "توثيق لقطات الفعاليات في معرض الصور",
      icon: <ImageIcon size={32} className="text-emerald-500" />,
      path: "/albums/manage",
      glow: "hover:shadow-[0_0_30px_rgba(16,185,129,0.3)] border-emerald-500/20",
    },
  ];
