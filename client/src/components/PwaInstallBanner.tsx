...
export function PwaInstallBanner() {
  ...
  return (
    <div className="fixed left-4 right-4 z-50 mx-auto max-w-md animate-in slide-in-from-bottom-5 duration-300" style={{ bottom: "calc(max(1rem, env(safe-area-inset-bottom) + 0.5rem))" }}>
