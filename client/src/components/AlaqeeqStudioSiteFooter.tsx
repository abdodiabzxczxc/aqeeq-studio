...
function SnapchatIcon({ size = 15, className = "" }: { size?: number; className?: string }) {
  return (
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10 pt-12 sm:pt-16 pb-10">
        {/* 1. Pre-Footer Call-to-Excellence Card (بانر دعوة التسجيل المتزن الفاخر) */}
        <div
        ...
        {/* 2. Main Footer Hierarchy Grid (4 متوازنة تماماً بنظام موحد) */}
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <span className={`text-xs font-bold block ${dark ? "text-slate-400" : "text-slate-500"}`}>
            ...
            <div className="flex flex-wrap items-center gap-2 pt-1">
              <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-[11px] font-bold ${
                dark ? "border-emerald-500/25 bg-emerald-500/5 text-emerald-300" : "border-emerald-600/20 bg-emerald-50 text-emerald-800"
              }`}>
              ...
              <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg border text-[11px] font-bold ${
                dark ? "border-[#f8ca14]/25 bg-[#f8ca14]/5 text-[#f8ca14]" : "border-amber-600/20 bg-amber-50 text-amber-800"
              }`}>
        ...
        <div className="py-8 border-b border-current/10 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className={`p-4 rounded-2xl border flex items-center gap-3 transition ${
            ...
            <div className="min-w-0">
              ...
              <a href={`tel:${boysPhone}`} className="text-sm font-black hover:text-emerald-500 transition dir-ltr block text-right">
                {boysPhone}
              </a>
            </div>
          </div>
          ...
          <div className={`p-4 rounded-2xl border flex items-center gap-3 transition ${
            ...
            <div className="min-w-0">
              ...
              <a href={`tel:${girlsPhone}`} className="text-sm font-black hover:text-amber-500 transition dir-ltr block text-right">
                {girlsPhone}
              </a>
            </div>
          </div>
        ...
        {/* 4. Bottom Row: Copyright + Social Icons + Back to Top */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-6 text-xs">
          <div className={`text-center sm:text-right font-bold ${dark ? "text-slate-400" : "text-slate-500"}`}>
            <span>© 2026 مدارس العقيق الأهلية والدولية · جميع الحقوق محفوظة.</span>
          </div>

          {/* Social Network Icons with uniform luxury styling */}
          <div className="flex items-center gap-2.5">
            ...
            <button
              type="button"
              onClick={scrollToTop}
              className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-black transition hover:scale-105 mr-2 ${
                dark
                  ? "border-white/10 bg-white/5 text-slate-300 hover:border-[#f8ca14] hover:text-[#f8ca14]"
